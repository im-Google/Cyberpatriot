#!/bin/bash
clear
echo "Edited by Tieran Ardizzone and Benjaman Delgado, Corn Scammers, SETA, San Antonio, TX, USA"
echo "Last Modified on Wednesday, December 6th, 2023, 11:05am"
echo "Linux Debian Script"
startTime=$(date +"%s")
printTime()
{
	endTime=$(date +"%s")
